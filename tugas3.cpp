...
/**
* karna kita tidak tau berapa banyak inputan maka kita memakai
* salah satu data structure linked list (mata kuliah Data Structure semester 1)
* dimana kita bisa memakai kelebihan dari dinamik memory.
* kita buat struct terlebih dulu.
*
* Mendefinisikan sebuah structure untuk element linked list
*/
typedef struct node_
{
	/* 
		karna kita hanya menyimpan nilai IP MHS maka
...
* @param start untuk menrima struct yg berisi nilai dan next
*/
void display(node *start)
{
	node *i = start;
...
{	
	...
	// memberitahukan kepada user ttng program
	cout << endl;
	cout << "    * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *" << endl;
	cout << "   *                                                             *" << endl;
...
/**
* procedure untuk menghapus data di memori
* karna kita memakai memory dinamis
